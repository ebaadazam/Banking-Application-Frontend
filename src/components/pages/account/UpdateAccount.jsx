...
const UpdateAccount = () => {
    ...
    useEffect(() => {
        const fetchAccountDetails = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/banking/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`${import.meta.env.VITE_BASE_URL}/api/banking/${id}`, formDataToSend, {
                headers: {
